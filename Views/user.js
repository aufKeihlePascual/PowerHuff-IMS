$(document).ready(function() {
    ...
    searchInput.addEventListener('input', function() {
        ...
        rows.forEach(row => {
            let username = row.cells[0].textContent.toLowerCase(); // Assumes the username is in the second column
            let role = row.cells[3].textContent.toLowerCase();    // Assumes the role is in the third column
